        ...
        <footer className="relative bg-white dark:bg-gray-950 border-t border-gray-100 dark:border-gray-800 mt-auto" role="contentinfo">
            ...
            <div className="max-w-7xl mx-auto py-14 px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10">
                    ...
                    <div>
                        ...
                        <ul className="space-y-2.5">
                            {[
                                ...
                                <li key={link.name}>
                                    <Link to={link.path} className="text-sm text-gray-600 dark:text-gray-400 hover:text-ieee-blue dark:hover:text-cyan-400 transition-colors">{link.name}</Link>
                                </li>
                            ))}
                        </ul>
                    </div>
                    ...
                    {/* Community */}
                    <div>
                        <h4 className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-4">Community</h4>
                        <ul className="space-y-2.5">
                            {[
                                { name: "Chapters & Societies", path: "/chapters" },
                            ...
                            {[
                                ...
                                <li key={name}>
                                    <a href={href} target="_blank" rel="noopener noreferrer" className="text-sm text-gray-600 dark:text-gray-400 hover:text-ieee-blue dark:hover:text-cyan-400 transition-colors flex items-center gap-1">
